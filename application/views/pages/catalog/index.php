<div class="px-24 pb-8">
    ...
    <h1 class="text-6xl">Инсталяции</h1>
</div>
<div class="bg-gray-theme rounded-bg px-24 pt-20">
    <div class="grid gap-6 grid-cols-4">
        <div class="bg-white rounded-card p-3.5 border-2 border-white border-solid hover:border-2 shadow-card hover:border-gray-200">
    ...
    <div class="text-center py-12">
        <a class="py-2.5 px-24 border border-sky-theme border-solid rounded-full" href="#">Посмотреть все</a>
    </div>
</div>
