            ...
            <div class="home-product-slider">
                <div>
                    <div class="bg-white rounded-card p-3.5 border-2 border-white border-solid hover:border-2 shadow-card hover:border-gray-200 mx-3">
                        <div class="flex justify-between items-center pb-3.5 px-2.5">
                            <h5 class="text-xl lg1:text-sm sm1:text-xs">2.650 MDL</h5>
                            <span class="text-sky-theme text-sm line-through lg1:text-sm sm1:text-xs">3.000 MDL</span>
                        </div>
                        <img class="object-cover w-full h-40 sm1:w-full sm1:h-full"src="/assets/img/front/rectangleCart2.png" alt="">
                        <div class="flex justify-between items-center text-sm text-gray-400 pt-3.5 lg1:text-xs sm1:text-xs">
                            <h5 class="uppercase">GROHE</h5>
                            <span class="relative lg1:-left-2">Art. 28512001</span>
                        </div>
                        <h2 class="text-lg leading-6 text-gray-900 pt-2 lg1:text-sm">Setul dușului igienic Grohe Bau Edge</h2>
                        <div class="flex justify-between pt-7 xl0:block">
                            <a href="#" class="xl0:relative bg-sky-theme rounded-xl py-3 px-8 w-full mr-2.5 text-center text-white text-sm leading-normal xl0:left-25 xl0:p-0 lg1:px-0 lg1:left-0 sm1:text-xs sm1:-left-25">
                                <span>В&nbsp;корзину</span>
                            </a>
                            <a href="#" class="xl0:relative w-[50px] text-center border border-solid border-gray-300 rounded-xl px-3 py-2.5 text-sky-theme flex items-center xl0:left-50 xl0:top-20 lg1:left-5 sm1:-left-25">
                ...
                <div>
                    <div class="bg-white rounded-card p-3.5 border-2 border-white border-solid hover:border-2 shadow-card hover:border-gray-200 mx-3">
                        ...
                        <img class="object-cover w-full h-40 sm1:w-full sm1:h-full"src="/assets/img/front/Rectangle_2.png" alt="">
                        <div class="flex justify-between items-center text-sm text-gray-400 pt-3.5 lg1:text-xs sm1:text-xs">
                            <h5 class="uppercase">GROHE</h5>
                            <span class="relative lg1:-left-2">Art. 28512001</span>
                        </div>
