                                        ...
                                        <table class="table table-bordered table-striped table-hover">
											...
											<? foreach ($langs as $lang) { ?>
                                                <tr>
                                                    ...
                                                    <td><input type="text" name="title<?=$lang?>" class="form-control" required></td>
                                                </tr>
											<? } ?>
											...
											<? foreach ($langs as $lang) { ?>
                                                <tr>
                                                    <td>Ссылка <?=$lang?></td>
                                                    <td><input type="text" name="url<?=$lang?>" class="form-control"></td>
                                                </tr>
											<? } ?>
                                            <? foreach ($langs as $lang) { ?>
                                                <tr>
                                                    <td>Кнопка <?=$lang?></td>
                                                    <td><input type="text" name="subtitle<?=$lang?>" class="form-control"></td>
                                                </tr>
                                            <? } ?>
                                            <tr>
                                                <td>Цвет текста</td>
                                                <td><input type="color" name="color" class="form-control" style="width: 70px" value="#ffffff"></td>
                                            </tr>
                                            <tr>
											...
											<? foreach ($langs as $lang) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="file" name="img<?= $lang ?>" id="file"
							...
							<?php foreach ($objects as $item): ?>
                                <tr style="height: 51px;">
                                    ...
                                    <td class="align-middle"><a style="font-weight: 900;"
                                                                href="<?= $e_path . $item->id; ?>"><?= $item->titleEN ?></a>
                                    </td>
                                    <td class="align-middle">
