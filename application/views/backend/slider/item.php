                            ...
                            <div class="table-scrollable">
                                <table class="table table-bordered table-striped table-hover">
                                    ...
                                    <? foreach ($langs as $lang) { ?>
                                        <tr>
                                            <td>Кнопка <?=$lang?></td>
                                            <td><input type="text" name="subtitle<?=$lang?>" value="<?=$item->{'subtitle'.$lang}?>" class="form-control"></td>
                                        </tr>
                                    <? } ?>
                                    <tr>
                                        <td>Цвет текста</td>
                                        <td><input type="color" name="color" class="form-control" style="width: 70px" value="<?=$item->{'color'}?>"></td>
                                    </tr>
                                    <tr>
                                        <td>Расположение текста</td>
                                        <td>
                                            <select name="text_alight" class="form-control">
                                                <option value="left" <?=$item->text_alight == 'left'?'selected':''?>>С лево</option>
                                                <option value="center" <?=$item->text_alight == 'center'?'selected':''?>>По центру</option>
                                                <option value="right" <?=$item->text_alight == 'right'?'selected':''?>>С право</option>
                                            </select>
                                        </td>
                                    </tr>
                                    <?foreach ($langs as $lang) {?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php if (!empty($item->{'img'.$lang})): ?>
                                                <?php $src = newthumbs($item->{'img'.$lang}, $table, 160, 50, '250x250x1', 1) ?>
                                                <br>
