...
<div class="content" style="padding: 30px 30px 30px;">
    <!-- BEGIN LOGIN FORM -->
    <form class="login-form text-center" action="/backend/login/" method="post">

        <div class="form-group text-center">
            <a href="/" target="_blank">
                <img src="/assets/img/codeigniter.png" width="190">
            </a>
        </div>
        ...
        <div class="form-group">
            ...
            <input class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off" placeholder="Логин" name="login" required/>
        </div>
        <div class="form-group">
            <label class="control-label visible-ie8 visible-ie9">Пароль</label>
            <input class="form-control form-control-solid placeholder-no-fix" type="password" autocomplete="off" placeholder="Пароль" name="password" required/>
        </div>
        <div class="form-group text-center" style="margin-bottom: 0px;">
            <input type="submit" class="btn green uppercase" value="Войти">
        </div>
    </form>
    <!-- END LOGIN FORM -->
</div>
